...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			address: '<h3 class="f-normal dark normal uppercase" style="padding: 5PX; letter-spacing: 1px; word-spacing: 3px;">The Void <span class="ultrabold">Studio</span></span></h3><i class="icon ion-ios-location f-big dark"></i>',
			styles: 'GRAYSCALE',
			origins: [
				['37.936294', '23.947394'],
				['37.975669', '23.733868']
